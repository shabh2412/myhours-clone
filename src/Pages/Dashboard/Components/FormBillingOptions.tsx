...
export default function FormBillingOptions({heading,inputChange,labour_rate,billing_rate}:pricing){
    return (
        <Stack bg="#f9fafb" p="30px" spacing="20px" borderRadius="10px">
                ...
                <Input name={heading==="Labour Rate" ? "labour_rate" : "billing_rate"} value={heading==="Labour Rate" ? labour_rate : billing_rate} onChange = {(e) => inputChange(e)} placeholder="0" bg="white"></Input>
        </Stack>
    )
}